...
| Table | Owner | Purpose | Inputs | Required columns | Trace/evidence requirement |
| --- | --- | --- | --- | --- | --- |
| `manager_profiles` | Deterministic analytics | Summarize manager trade/waiver tendencies | `teams`, `trades`, `waivers`, `roster_players` | `roster_id`, `display_name`, `team_name`, `total_trades`, `trades_by_season`, `players_acquired`, `players_sold`, `picks_acquired`, `picks_sold`, `future_1sts_acquired`, `future_1sts_sold`, `future_2nds_acquired`, `future_2nds_sold`, `faab_spent_on_waivers`, `number_of_waiver_claims`, `average_waiver_bid`, `max_waiver_bid`, `most_common_transaction_partners`, `qb_count`, `rb_count`, `pass_catcher_count`, `contender_rebuilder_indicator`, `notes` | derived from transaction and roster IDs |
